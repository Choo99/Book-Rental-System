...
public class PaymentSearchButtonListener implements ActionListener{
    ...
    public PaymentSearchButtonListener (JTextField rentalIDField, JTextField nameField, JTextField currentDateField, JTextField expectedField,JTextField rentalFeeField , JButton printButton,JTextField rentalIDField2)
	{
