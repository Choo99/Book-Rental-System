...
public class ViewAdminAddBook extends JFrame {
	...
	public ViewAdminAddBook(User user) {
		...
		JRadioButton addNewBookRadioButton = new JRadioButton("Add New Book");
		...
		JRadioButton addCopyRadioButton = new JRadioButton("Add Copy");
		...
		JButton searchIDButton = new JButton("");
		...
		ActionListener actionListener = new AddBookJRadioButtonListener(addNewBookRadioButton,addNewBookPanel,addCopyPanel);
		addNewBookRadioButton.addActionListener(actionListener);

		ActionListener actionListener2 = new AddCopyJRadioButtonListener(addCopyRadioButton,addNewBookPanel,addCopyPanel);
		addCopyRadioButton.addActionListener(actionListener2);
		
		ActionListener actionListener3 = new AddBookButtonListener(this,titleField,authorField,bookTypeComboBox,quantityField,user);
		addNewBookButton.addActionListener(actionListener3);
		
		ActionListener actionListener4 = new AddCopyButtonListener (this,bookIDField, quantityField2, bookNameField, user);
		...
		ActionListener actionListener6 = new AddCopySearchBookIDButtonListener (bookIDField, bookNameField, quantityField2, addCopyButton);
