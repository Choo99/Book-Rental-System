...
public class ViewBookReturn extends JFrame {
	...
	private ViewOverdueFeeReceipt overdue;
	...
	public ViewBookReturn(User user) {
		...
		ActionListener actionListener2 = new BookReturnSearchButtonListener(rentalIDField, customerNameField,
				expectedDateField, returnDateField, rentalIDField2);
		searchButton.addActionListener(actionListener2);

		ActionListener actionListener3 = new BookReturnUpdateButtonListener(this,rentalIDField2, customerNameField,
				expectedDateField, returnDateField, user);
	...
	public ViewOverdueFeeReceipt getOverdue() {
		return overdue;
	}

	public void setOverdue(ViewOverdueFeeReceipt overdue) {
		this.overdue = overdue;
	}

	public JTextField getExpectedDateField() {
