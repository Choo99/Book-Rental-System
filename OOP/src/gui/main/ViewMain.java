...
public class ViewMain extends JFrame {
	...
	public ViewMain(User user) {
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup().addGap(340).addComponent(MainIcon).addContainerGap(335,
						Short.MAX_VALUE))
				.addGroup(gl_contentPane.createSequentialGroup().addContainerGap(233, Short.MAX_VALUE)
						.addComponent(tittle, GroupLayout.PREFERRED_SIZE, 413, GroupLayout.PREFERRED_SIZE).addGap(157))
				.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup().addGap(247)
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addPreferredGap(ComponentPlacement.RELATED).addComponent(tittle).addGap(18)
