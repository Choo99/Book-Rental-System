...
public class ViewBilling extends JFrame 
{
	...
	public ViewBilling(User user) 
	{
		...
		ActionListener actionlistener = new PaymentSearchButtonListener (rentalIDField, nameField, currentDateField, expectedField, rentalFeeField, printButton,rentalIDField2);
